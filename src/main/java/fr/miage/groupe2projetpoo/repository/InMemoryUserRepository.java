...
public class InMemoryUserRepository implements UserRepository {
    ...
    public void init() {
        ...
        Moto moto2 = new Moto(8, "Moto", "Honda", "Noir", "CB650R", "Bordeaux", true, 65.0,
                agentPro2, new ArrayList<>(disponibilites30Jours));
