...
public class DataInitializer {
    ...
    public void init() {
        ...
        Moto moto2 = new Moto("8", "Honda", "Noir", "CB650R", "Bordeaux", 65.0, "bob@test.com", false); // Note: Code
                                                                                                        // original
                                                                                                        // avait
                                                                                                        // bob@test.com
                                                                                                        // pour moto2,
        ...
        Voiture voitureV1 = new Voiture("V001", "Bleu", "Renault", "Clio", "Paris", 30.0, "jean@email.com", false); // Assigné
                                                                                                                    // à
                                                                                                                    // Jean
        Voiture voitureV2 = new Voiture("V002", "Peugeot", "Noir", "3008", "Lyon", 50.0, "marie@email.com", false); // Assigné
                                                                                                                    // à
                                                                                                                    // Marie
