...
public class DataInitializer {
    ...
    public void init() {
        ...
        Voiture voiture3 = new Voiture("3", "BMW", "Blanc", "Serie 3", "Marseille", 85.0, "bob@test.com", false);
        Moto moto1 = new Moto("4", "Yamaha", "Rouge", "MT-07", "Nice", 60.0, "bob@test.com", false);
        Voiture voiture4 = new Voiture("5", "Mercedes", "Gris", "Classe A", "Paris", 90.0, "enterprise1@test.com",
                false);
        Camion camion1 = new Camion("6", "Renault", "Blanc", "Master", "Paris", 120.0, "enterprise1@test.com", false);
        Camion camion2 = new Camion("7", "Mercedes", "Jaune", "Sprinter", "Lyon", 135.0, "enterprise1@test.com", false);
        Moto moto2 = new Moto("8", "Honda", "Noir", "CB650R", "Bordeaux", 65.0, "bob@test.com", false);

        // Véhicules Legacy
        Voiture voitureV1 = new Voiture("V001", "Bleu", "Renault", "Clio", "Paris", 30.0, "jean@email.com", false);
        Voiture voitureV2 = new Voiture("V002", "Peugeot", "Noir", "3008", "Lyon", 50.0, "marie@email.com", false);
